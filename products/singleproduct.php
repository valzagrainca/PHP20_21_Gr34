            ...
            <div class="containeer">
                ...
                <nav class="m-nav">
                    ...
                    <ul class="nav-l">
                        ...
                        <li class="nav-l-i">
                          <div class="dropdown">
                            <button class="dropbtn"> <a href="../fundingprograms/fundingprograms.php" class="link">Funding  <i class="fa fa-caret-down" style="font-size:18px;"></i></a>
                            </button>
              ...
              <ul class="nav-l">
                ...
                <?php
                    if(isset($_SESSION["useruid"])) {
                        echo "<a class='link link_button' href='../fundingprograms/profile.php'>Profile</a>";
                        echo '<a class="link link_button" href="../fundingprograms/logout.inc.php">Log out</a>';
                    }
                    else {
                        echo '<a class="link link_button" href="../fundingprograms/login.php">Join Us</a>';
                    }
                    ?>
                </li>
              </ul>
